        ...
        for (const sib of siblings) {
            ...
            function walk(node, path) {
                ...
                if (!schemas.vegaEmbedChart && resType === 'webmasters-aem/components/vegaEmbedChart') {
                    const hasContent = Object.keys(node).some((k) => !k.startsWith('jcr:') && !k.startsWith('sling:') && !k.startsWith(':') && typeof node[k] !== 'object');
                    if (hasContent) {
                ...
                if (!schemas.containerV2 && resType === 'webmasters-aem/components/container/v2/container') {
                    const childKeys = Object.keys(node).filter((k) => !k.startsWith('jcr:') && !k.startsWith('sling:') && !k.startsWith('cq:') && !k.startsWith(':') && typeof node[k] === 'object');
                    if (childKeys.length > 0) {
                        schemas.containerV2 = {
                            ...
                            childKeys,
                            fullNode: Object.fromEntries(Object.entries(node).filter(([k]) => typeof node[k] !== 'object' || k === childKeys[0])),
                        };
