...
export function populateStep4() {
  ...
  const btnInsert = document.getElementById('btn-insert-kf') as HTMLButtonElement
  const btnCopy = document.getElementById('btn-copy-kf') as HTMLButtonElement
...
function populateAuthorsPreview(article) {
  ...
  const btnInsert = document.getElementById('btn-insert-authors') as HTMLButtonElement
...
function populateFootnotesPreview(article) {
  ...
  const btnInsert = document.getElementById('btn-insert-footnotes') as HTMLButtonElement
...
function populateRelatedContentPreview(article) {
  ...
  const btnInsert = document.getElementById('btn-insert-related') as HTMLButtonElement
...
function populateBodyBlocksPreview(article) {
  ...
  const btnInsertBody = document.getElementById('btn-insert-body') as HTMLButtonElement
