...
export function populateStep2() {
  ...
  document.getElementById('exhibits-count').textContent = String(exhibitAssets.length)
  document.getElementById('banners-count').textContent = String(bannerAssets.length)
  ...
  ;(document.getElementById('dam-link') as HTMLAnchorElement).href = `${AEM_HOST}/ui#/aem/assets.html${damPath}`
  ...
  ;(document.getElementById('btn-publish-assets') as HTMLButtonElement).disabled = false
  ...
  `
  const refreshBtn = document.getElementById('btn-refresh-assets') as HTMLButtonElement
...
export async function refreshAssets() {
  const btn = document.getElementById('btn-refresh-assets') as HTMLButtonElement
  btn.disabled = true
